...
inputForm.addEventListener('submit', (e) => {
    ...
    const playerData = [
        { name: playerOneName, wins: 0, losses: 0, draws: 0, color: playerColors[0], lastGameResult: '' }, 
        { name: playerTwoName, wins: 0, losses: 0, draws: 0, color: playerColors[1], lastGameResult: '' },
    ];
